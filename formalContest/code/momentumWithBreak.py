...
for index, row in data.iterrows():
    ...
    if row['point_victor'] == 1:
        ...
        score_after_break_2 = 0
        # 连续得分权重更新
        C_t_1 = 1 + consecutive_wins_1 * 0.2
        B_t_1 = 2 + score_after_break_1 * 0.4
        C_t_2 = 1 + consecutive_wins_2 * 0.2
        B_t_2 = 2 + score_after_break_2 * 0.4

        # 势头更新
        momentum_score_1 += (S_t_1 * C_t_1 * B_t_1)
        momentum_score_2 += (S_t_2 * C_t_2 * B_t_2)
